...
SEED = 42
BATCH_SIZE = 256  # Aumentado para mejor eficiencia
EPOCHS = 100
LEARNING_RATE = 0.0005  # Reducido para mejor convergencia
TEST_SIZE = 0.2
VAL_SIZE = 0.2
...
MODEL_NAME = 'diabetes_classifier_model_v2.pth'
CONFUSION_MATRIX_NAME = 'confusion_matrix_v2.png'
TRAINING_METRICS_NAME = 'training_metrics_v2.png'
FINAL_CONFUSION_MATRIX_NAME = 'final_test_confusion_matrix_v2.png'
FINAL_CLASSIFICATION_REPORT_NAME = 'final_classification_report_v2.txt'
FINAL_METRICS_CHART_NAME = 'final_test_metrics_chart_v2.png'

# --- Variables Globales para los Nombres de Archivos CSV ---
FINAL_TEST_CSV_NAME = 'diabetes_prueba_final_v2.csv'
TRAIN_VAL_CSV_NAME = 'diabetes_entrenamiento_validacion_v2.csv'

# --- Configuración de Pesos de Clase ---
MANUAL_CLASS_WEIGHTS = True
CLASS_WEIGHTS_VALUES = [1.0, 2.0]  # Aumentado el peso para diabetes

# --- Configuración de Umbral de Decisión ---
PREDICTION_THRESHOLD = 0.35  # Ajustado para mejor balance
...
class DiabetesClassifier(nn.Module):
    ...
    Arquitectura optimizada para mejor eficiencia.
    """
...
def load_and_preprocess_data(batch_size: int = 256):
    """
...
def plot_metrics(train_losses, val_f1_scores_diabetes, val_accuracies, save_dir: str, file_name: str):
    """
    Genera y guarda gráficos de métricas.
    """
    try:
        ...
        plt.subplot(1, 2, 2)
        plt.plot(epochs_range, val_f1_scores_diabetes, label='F1-Score (Diabetes)', color='orange')
        plt.plot(epochs_range, val_accuracies, label='Accuracy', color='green', linestyle='--')
...
def main():
    try:
        ...
        # Evaluación final
        print(f"\nEvaluando el mejor modelo en el conjunto de prueba final (Umbral: {PREDICTION_THRESHOLD:.2f})...")
